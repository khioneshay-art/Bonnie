...
(async function init(){
  try{const u=await getUser();setConnection(!!u,u?"Supabase connected":"Supabase reachable — sign-in not configured");await loadBusinesses();await loadMemory();await loadConversations()}
